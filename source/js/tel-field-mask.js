import { isBackspaceEvent } from './util.js';

function setTelFieldMask(fieldElement) {
  ...
  function onFieldKeydown(evt) {
    ...
    if (isBackspaceEvent(evt) && getInputNumbersValue(input).length === 1) {
      input.value = '';
    }
  }
